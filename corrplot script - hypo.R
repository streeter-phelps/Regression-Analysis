...
library(readxl)
dataset <- read_excel("E:/data_analysis/Suman Dai Manuscript/correlation_regression_dec18_2023/Hypotrachyna_Correlation.xlsx")
View(dataset)
...
png(filename = "Correlogram_hypotrachyna.png",
    width = 3600, height = 3600, units = "px", pointsize = 6,
